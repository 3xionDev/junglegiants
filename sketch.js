...
function preload() {
   bgImg = loadImage("tree.png");
   monkeyImg = loadImage("monkey.png");
   deathWallImg = loadImage("fire.png");
}
...
function drawWorldLayers() {
  ...
  translate(deathWallX - (wallWidth / 2) + offset, camY);
  
  rotate(HALF_PI);
  
  imageMode(CENTER);
  
  image(deathWallImg, 0, 0, wallHeight, wallWidth);
...
class Monkey {
  ...
  show() {
    ...
    noStroke();
    image(monkeyImg, this.pos.x, this.pos.y, 200, 100);
  }
}
